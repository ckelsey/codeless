...
// const url = `${serverBaseUrl}/tests/components/field-text/`
...
// test('field-text exists', async ({ page }) => {
//     await page.goto(url)
...
// test('field-text has 1 input by default', async ({ page }) => {
...
// test.only('field-text input can be set by attribute as a string, creates a new input', async () => {
//     const coverage = await coveragePage(url)
...
//     fs.writeFileSync(path.join(path.resolve(''), 'coverage.json'), JSON.stringify(report))
// })

// // test.only('field-text input can be set by attribute as a string, creates a new input', async ({ page }) => {
// //     const helper = await goToPageAndGetHelper(page)
// //     const createdOnInitial = await helper.getCreatedOn('input')
// //     const result = await helper.slotAttributeString('input', '')
// //     const createdOnNext = await helper.getCreatedOn('input')
...
// test('field-text input can be set by attrbute using a selector', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by attrbute using a selector without slot attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by property as a string, creates a new input', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by property using dom element', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by property using dom element without slot attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by property using HTML string', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by field-text.appendChild with an element with the right slot attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text input can be set by field-text.insertBefore with an element with the right slot attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const createdOnInitial = await helper.getCreatedOn('input')
...
// test('field-text label, error, help, iconleft, and iconright by default is empty and has only 1 slot element', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by attribute value', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by attrbute using a selector', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by attrbute using a selector without slot attribute filled', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by property value', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by property value using a selector', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by property value using a selector without slot attribute filled', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by property using dom element', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by property using dom element without slot attribute filled', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can take an HTML string', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can take an HTML string but strip out script tags', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const src = 'http://localhost:3000/favicon.png'
...
// test('field-text label, error, help, iconleft, and iconright can be set by field-text.appendChild with an element with the right slot attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label, error, help, iconleft, and iconright can be set by field-text.insertBefore with an element with the right slot attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label is not clickable', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label inherits font size', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label has "for" attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label has for attribute after inputid update', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label changes size if value', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text label changes size if focused', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const size1: any = await helper.componentEval((node: any) => {
//         node.label = 'A label'
//         return node.label.getBoundingClientRect().height
...
// test('field-text error inherits font size but 70%', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const sizes: any = await helper.componentEval((node: any) => {
//         node.error = 'A error'
//         return {
...
// test('field-text error is displayed when validation error', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text error x icon is displayed when validation error', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     await helper.validationError()
...
// test('field-text error border is displayed when validation error', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text error-message attribute is set when validation error', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text error clears after validity is ok', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     await helper.validationError()
...
// test('field-text user input updates component value', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const value = 'test@t'
...
// test('field-text autocomplete updates input attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text autofocus updates input attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text autofocus sets or removes focus to the input', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text count when set to true displays the value character count', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const value = '1234'
...
// test('field-text disabled updates the input disabled attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const value = 'dssdsd'
//     await page.fill('field-text input', value)
...
// test('field-text inputid updates the input id', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// /** MAX ================================================================ */
// test('field-text max updates the input maxlength', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text max will be displayed if count is enabled', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
//     const value = '1234'
//     expect(await helper.componentEval((node: any) => node.max)).toBe(null)
//     expect(await (await (await helper.component())?.$('.field-count-text'))?.isVisible()).toBe(false)
...
// test('field-text min updates the input minlength', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text name updates the input name', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text pattern updates the input pattern', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
...
// test('field-text required updates the input required attribute', async ({ page }) => {
//     const helper = await goToPageAndGetHelper(page)
